	...
	<form class="" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		...
		<div class="product-add-to-cart">
			...
			<div class="product-add-to-cart__button">
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button btn btn--yellow"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
			</div>
