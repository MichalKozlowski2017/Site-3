...
?> <div class="content-box--white content-box form-edit-account"> <?php
...
<?php else : ?>
    ...
    <p><?php _e( 'No order has been made yet.', 'woocommerce' ); ?></p>
      	<a class="btn btn--yellow" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<button><?php _e( 'Go shop', 'woocommerce' ) ?></button>
    </div>
