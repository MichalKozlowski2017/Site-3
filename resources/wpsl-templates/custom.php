...
$output .= "\t" . '<div class="wpsl-search wpsl-clearfix store-locator-wrapper__nav' . $this->get_css_classes() . '">' . "\r\n";
...
$output .= "\t\t\t\t" . '<div class="wpsl-select-wrapper">' . "\r\n";
...
$output .= "\t\t\t\t" . '</select>' . "\r\n";
$output .= "\t\t\t\t" . '</div>' . "\r\n";
$output .= "\t\t\t\t" . '<button class="wpsl-search-btn-wrap btn btn--yellow" id="wpsl-search-btn" type="submit">' . esc_attr( $wpsl->i18n->get_translation( 'search_btn_label', __( 'Search', 'wpsl' ) ) ) . '</button>' . "\r\n";
$output .= "\t\t\t" . '</div>' . "\r\n";
...
$output .= "\t" . '<div id="wpsl-gmap" class="wpsl-gmap-canvas store-locator-wrapper__map"></div>' . "\r\n";
